...
- [x] P2 UX-QA-005 — Bouton × du modal premium intercepté par la vague SVG de la fiche plage quand la fiche reste au-dessus — **CLOS 2026-09-21** : fix a1585b563 (UX-R2-003, panel z1260 > fiche z1200) vérifié en prod mobile 390×844 — × cliquable au-dessus de la fiche, dialog réellement fermé (`ux-qa-006-plus-tard.spec.ts` « mobile : × ferme aussi »)
- [x] P2 UX-QA-006 — « Plus tard » ne ferme pas le modal premium sur desktop — **CLOS 2026-09-21, non reproductible** : le run1 (2026-09-16) a tourné AVANT le fix a1585b563 (2026-09-17) ; depuis, « Plus tard » ferme réellement le dialog en local build + prod, desktop 1440×900 ET mobile 390×844 (5/5 `ux-qa-006-plus-tard.spec.ts`, 0 pageerror) ; contrat `ux-qa-006-plus-tard.test.cjs` 11/11 verrouille onClick=onClose + z1260
