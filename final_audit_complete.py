...
with sync_playwright() as pw:
    ...
    beach_btns = page.locator('[data-beach], button:has-text("Voir")')
    ...
    if beach_clicked:
        # 3. Check forecast cards for scrub
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=10) as resp:
            ...
            expected = '513f483c'  # first 8 chars of commit 513f483c6
