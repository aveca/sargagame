...
<html lang="fr">
  <head>
    ...
    <script type="application/ld+json">
    {"@context":"https://schema.org","@type":"Organization","name":"Sargasses Guadeloupe","url":"https://sargasses-guadeloupe.com","logo":"https://sargasses-guadeloupe.com/icon-512.png","description":"Surveillance des sargasses en temps réel en Guadeloupe — carte satellite, prévisions 7 jours, alertes push pour 82 plages.","areaServed":{"@type":"AdministrativeArea","name":"Guadeloupe"},"knowsAbout":["sargasses","algues","plages Guadeloupe","Grande-Terre","Basse-Terre","Sainte-Anne","Le Gosier","Deshaies","AFAI","Copernicus Marine"],"sameAs":["https://sargasses-martinique.com"]}
    </script>
    <script type="application/ld+json">
