...
async function fetchFunnelFromSupabase() {
  ...
  const FUNNEL_KEYS = ['session_start', 'forecast_lock_click', 'premium_modal_open', 'premium_modal_cta', 'pass_cta', 'pass_offer_view', 'conversion', 'email_submit', 'mollie_checkout_redirect', 'checkout_redirect', 'onsite_checkout_opened', 'pay_onsite_back', 'planb_view', 'planb_pick', 'beach_report', 'observation', 'b2b_widget_preview', 'b2b_lead_success', 'subscription_created', 'ma_plage_open', 'ma_plage_fav_toggle', 'ma_plage_alerts_toggle', 'ma_plage_alerts_enable', 'ma_plage_premium_cta', 'nav_tab', 'compare_add', 'compare_open', 'plages_filter', 'home_best_open', 'suivi_alert_toggle']
  const counts = {}
