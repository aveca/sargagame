...
const UNIFIED_PATH = path.join(__dirname, 'data', 'b2b-contacts-unified.json')
const SRC_PATH = fs.existsSync(UNIFIED_PATH) ? UNIFIED_PATH : path.join(__dirname, 'data', 'b2b-enriched.json')
