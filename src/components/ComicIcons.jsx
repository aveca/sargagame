...
const P = {
  ...
  flag: <><path d="M6 21V4"/><path d="M6 4.5h11l-2.5 3.5 2.5 3.5H6"/></>,
  cloud: <path d="M7 18a4.5 4.5 0 0 1-.4-9A6 6 0 0 1 18.2 10 3.8 3.8 0 0 1 17.5 18z"/>,
  rain: <><path d="M7 15a4.5 4.5 0 0 1-.4-9A6 6 0 0 1 18.2 7 3.8 3.8 0 0 1 17.5 15z"/><path d="M8.5 18v2.5M12.5 18v2.5M16.5 18v2.5"/></>,
