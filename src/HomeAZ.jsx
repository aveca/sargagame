...
export function initHomeAZ(SR, HOST, opts){
  ...
  var T = {
    ...
    m2b3s:       {fr:"7 jours de prévisions, baie par baie — et quand la confiance baisse, on te le dit.", en:"7-day forecast, bay by bay — and when confidence drops, we tell you.", es:"Pronóstico a 7 días, bahía por bahía — y cuando baja la confianza, te lo decimos."},
    ...
    reassure:    {fr:"Pass unique, dès 7,99 € — pas d'abonnement, remboursé en un email sous 30 jours.", en:"One-time Pass from $5.99 — no subscription, refunded in one email within 30 days.", es:"Pass único desde $5.99 — sin suscripción, reembolso en un correo en 30 días."},
