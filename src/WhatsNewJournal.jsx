// WhatsNewJournal.jsx — journal « nouveautés » par release (overlay), extrait du monolithe
// pour alléger le bundle eager. Hors first-paint (whatsNew=null au mount, set async si release non vue).
