// StoryScenes.jsx — overlays narratifs SVG hors first-paint (extraits de
// Sargasses_PROD.jsx pour alléger le bundle eager du chemin critique).
...
export function StationStory({slug,lang,onExit,onCTA}){
...
export function SolutionsStory({lang,onClose,onExit}){
