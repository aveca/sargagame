...
// plage propre (afai bas) n'est jamais peinte en orange/rouge "attention" parce
// qu'elle est ventée ou couverte ; une plage avec sargasses n'est jamais peinte
// en vert éclatant. Le score composite (météo 70 %) ne fait que GRADER À
// L'INTÉRIEUR de la bande autorisée par le statut sargasses. Seuils afai alignés
// sur statusFromAfai (0.15 / 0.40) pour rester cohérent avec la carte.
export function labelFor(score, afai) {
