...
/* ====================================================================
   ...
   Adapté full-screen : z-index couvre l'app, fond #190c2c
   ==================================================================== */
const CL_CSS = `
...
.pb-kicker{font-size:11px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#d6249f;
...
.conf .bar>i{display:block;height:100%;background:#d6249f;border-radius:2px}
...
export default function CleanList(props){
  ...
  return React.createElement("div",{ref:hostRef,role:"dialog","aria-label":_t(lang,"Plages propres aujourd'hui","Clean beaches today","Playas limpias hoy"),style:{position:"absolute",inset:0,zIndex:1050,overflow:"hidden",background:"#190c2c"}});
}
