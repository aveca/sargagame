...
**Preuves** : b2b-scoring 43/43 · sirene-import 77/77 (fixtures locales, mock PostgREST mémoire, idempotence rejouée prouvée, `--execute` sans config → exit 1) · b2b-phase2-guards 33/33 (anti-activation : pas de réf outreach/email/paiement/vocal, aucun workflow ne lance l'importeur, aucune clé en dur) · b2b-sales-engine-schema 82/82.
