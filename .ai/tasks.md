## FERMETURE #672 — BUG-2026-036 [x] fixé + vérifié CI 21/21 (2026-09-15)
...
- **Preuves** : funnel 13/13 · bottomnav 8/8 · matrice 4 configs · j0 65/65 · CI playwright 21/21 (3m04s) · screenshot carte libérée.
- **Statut** : PR #672 MERGÉE 18385d13, deploy-live SUCCESS, health 6/6, live vérifié (espace MQ+Miami, worker, bundles).

## B2B MONTHLY — [x] DONE LIVE (2026-09-15, PR #672 mergée 18385d13, deploy SUCCESS, health 6/6)
...
- **Preuves** : worker 37/37 · j0 61/61 · distro 60/60 · build/bundle/smoke verts · php -l · E2E local espace vert · probes live sûres MQ+Miami · paylinks annuels live · bundles prod vérifiés (bridge + readiness + dismiss).
- **Reste (gardes fondateur)** : mint trial réel (1 curl), subscription réelle (1 paiement — nouveau mécanisme), analytics prod (1 lecture Supabase) → §8.
- **NEXT** : §8 → monitorer funnel-b2b 7j → rebaser l'édition concurrente (funnel spec, HomeJuicy, app-runtime, RegionNav).
