...
1. **Secrets rotation** (exposed in git history)
   - `MOLLIE_API_KEY=live_REDACTED` (valeur live purgée de l'arbre — A12 ; présente dans l'historique commit 3f07490 → révocation dashboard Mollie requise, action fondateur)
